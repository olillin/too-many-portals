...
execute store result score $y too_many_portals run data get entity @e[type=marker,tag=too_many_portals.force,limit=1,sort=nearest] Pos[1]
...
execute store result entity @e[type=marker,tag=too_many_portals.force,limit=1,sort=nearest] Pos[1] double 1 run scoreboard players get $y too_many_portals
# Create portal
execute if score $x_portal too_many_portals matches 1 at @e[type=marker,tag=too_many_portals.force,limit=1,sort=nearest] run function too_many_portals:portals/{{ too_many_portals.portal.dimension_a_id }}/{{ too_many_portals.portal.dimension_b_id }}/generate/force_x
execute if score $x_portal too_many_portals matches 0 at @e[type=marker,tag=too_many_portals.force,limit=1,sort=nearest] run function too_many_portals:portals/{{ too_many_portals.portal.dimension_a_id }}/{{ too_many_portals.portal.dimension_b_id }}/generate/force_z
# Kill marker
